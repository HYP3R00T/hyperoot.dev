...
description: "Experimentally deployed EKS reference architecture combining Terraform, FluxCD, Kustomize, and CI/CD."
icon: "kubernetes"
order: 10
technologies: ["EKS", "Terraform", "FluxCD", "Kustomize"]
